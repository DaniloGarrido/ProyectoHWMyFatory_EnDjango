...
from .models import Categoria, Producto,Marca,Compra 
...
def ListaProductos(request):
    producto = Producto.objects.all()      #similar al comando select
    categoria=Categoria.objects.all()
    data={'producto':producto,
    'categoria':categoria}
    return render (request, 'catalogo/producto_list.html', data)
#///////////////////////
